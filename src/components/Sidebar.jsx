const Sidebar = () => {
  return (
    <div className='flex flex-col items-center gap-y-[256px] py-5 bg-[#F7F8FA] '>
      <div className='main-menu flex flex-col gap-y-5'>
        ...
        <div className='cursor-pointer px-5 relative'>
          ...
          <div className='small-bar absolute inset-right'>
            <svg
              width='3'
              height='21'
              viewBox='0 0 3 21'
        ...
        <div className='theme flex flex-col items-center p-[10px]'>
          <div className='theme-btn-container rounded-[100px] flex flex-col gap-y-4 bg-white p-2'>
      ...
      <div className='other-menu flex flex-col gap-y-4'>
        <div className='cursor-pointer px-5'>
          <svg
            width='40'
            height='40'
